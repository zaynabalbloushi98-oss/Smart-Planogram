...
def detect_products(image):
    ...
    input_tensor, original_w, original_h = (
...
def build_planogram_from_detections(detections):
    ...
    for product in CLASS_NAMES:
        ...
        # Most common zone becomes expected position
...
def analyze_planogram(
    ...
    for product, expected_data in (
        expected_config.items()
    ):

        expected_qty = expected_data[
            "quantity"
        ]

        expected_position = expected_data[
            "position"
        ]
    ...
    if total_products == 0:
        ...
        quantity_compliance = (
            correct_quantity_products
            / total_products
        ) * 100

        position_compliance = (
            correct_position_products
            / total_products
        ) * 100
...
def analyze():
    ...
    if (
        "planogram" not in request.files
        or "image" not in request.files
    ):

        return (
            "Please upload both a planogram "
            "image and a shelf image",
            400
        )

    planogram_file = request.files[
        "planogram"
    ]

    shelf_file = request.files[
        "image"
    ]

    if (
        planogram_file.filename == ""
        or shelf_file.filename == ""
    ):
    ...
    # ========================================================
    # READ PLANOGRAM IMAGE
    # ========================================================

    planogram_image = cv2.imread(
        planogram_path
    )
    ...
    # ========================================================
    # PLANOGRAM RESOLUTION CHECK
    # ========================================================

    if (
        planogram_width < MIN_IMAGE_WIDTH
        or
        planogram_height < MIN_IMAGE_HEIGHT
    ):
    ...
    if not planogram_detections:
        ...
        <p>
            Please upload a clear planogram
            image containing the supported
            products.
        </p>
        """, 400

    # ========================================================
    # BUILD DYNAMIC PLANOGRAM
    # ========================================================
    ...
    # ========================================================
    # PLANOGRAM ANALYSIS INFORMATION
    # ========================================================
    ...
    # ========================================================
    # SHELF RESOLUTION CHECK
    # ========================================================

    if (
        shelf_width < MIN_IMAGE_WIDTH
        or
        shelf_height < MIN_IMAGE_HEIGHT
    ):
    ...
    # ========================================================
    # COMPARE SHELF WITH UPLOADED PLANOGRAM
    # ========================================================
